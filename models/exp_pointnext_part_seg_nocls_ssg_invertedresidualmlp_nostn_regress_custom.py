...
# ==========================================
# 2. Main Model: SSG + INVERTEDRESIDUALMLP + NOSTN (REGRESS_CUSTOM)
# ==========================================
class get_model(nn.Module):
    def __init__(self, num_part, normal_channel=True, grid_num=4):
        ...
        self.res1 = InvertedResidualMLP(64, expansion_ratio=4)
        self.sa2 = PointNetSetAbstraction(256, 0.2, 32, 64 + 3, [64, 64, 128], False)
        self.res2 = InvertedResidualMLP(128, expansion_ratio=4)
        self.sa3 = PointNetSetAbstraction(64, 0.4, 32, 128 + 3, [128, 128, 256], False)
        self.res3 = InvertedResidualMLP(256, expansion_ratio=4)
        # --- Decoder ---
