...
class IncreasingMLP(nn.Module):
    def __init__(self, in_channel, mlp):
        ...
        # 為保持 FP 層結構不變，最後一層強迫轉回 in_channel
...
# ==========================================
# 2. Main Model: MSG + INCREASINGMLP + NOSTN
# ==========================================
