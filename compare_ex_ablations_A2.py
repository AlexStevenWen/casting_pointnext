...
EXPERIMENTS = {
    ...
    "msg_increasingmlp_nostn_seg_custom_fps_2048":"./log/part_seg/exp_pointnext_part_seg_nocls_msg_increasingmlp_nostn_seg_custom_2026-06-23_15-22-37/training_metrics_history.csv",
}
OUTPUT_DIR = "./ablation_test_A2"
